...
const Features = () => {
    return (
        <section className="flex-col flexCenter overflow-hidden bg-feature-bg bg-certer bg-no-repeat py-24">
            <div className="max-container padding-container relative w-full flex justify-end">
                ...
                <div className="z-20 flex flex-col w-full lg:w-[60%]">
                    ...
                    <ul className="mt-10 grid md:grid-cols-2 gap-10 lg:mt-20 lg:gap-20">
